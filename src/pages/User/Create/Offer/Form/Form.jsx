      ...
      <div className='b-offer-header'>
        ...
        <form onSubmit={(handleSubmit(enviar))}>
            ...
            <select className='b-create-offer-form-select' {...register("vacancies")}>
              ...
              {JSON.parse(localStorage.getItem('copyoffer')).vacancies >= 5 ? <option value="5" selected>5+</option> : <option value="5">5+</option>}
            </select>
            <h5>Idioma</h5>
            ...
            <select className='b-create-offer-form-select' {...register("sector")}>
              {JSON.parse(localStorage.getItem('copyoffer')).sector === 'Tecnológico' ? <option value="Tecnológico" selected>Tecnológico</option> : JSON.parse(localStorage.getItem('copyoffer')).sector === undefined ? <option value="Tecnológico" selected>Tecnológico</option> : <option value="Tecnológico">Tecnológico</option> }
              ...
              {JSON.parse(localStorage.getItem('copyoffer')).sector !== undefined && JSON.parse(localStorage.getItem('copyoffer')).sector !== 'Tecnológico' && JSON.parse(localStorage.getItem('copyoffer')).sector !== 'Aeroespacial' && JSON.parse(localStorage.getItem('copyoffer')).sector !== 'Hostelería' && JSON.parse(localStorage.getItem('copyoffer')).sector !== 'Automovilístico' ? <option value={JSON.parse(localStorage.getItem('copyoffer')).sector} selected>{JSON.parse(localStorage.getItem('copyoffer')).sector}</option> : ''}
            ...
            <select className='b-create-offer-form-select' {...register("location.city")}>
              {JSON.parse(localStorage.getItem('copyoffer')).location && JSON.parse(localStorage.getItem('copyoffer')).location.city === 'Madrid' ? <option value="Madrid" select>Madrid</option> : <option value="Madrid">Madrid</option>}
              {JSON.parse(localStorage.getItem('copyoffer')).location && JSON.parse(localStorage.getItem('copyoffer')).location.city === 'París' ? <option value="París" select>París</option> : <option value="París">París</option>}
            ...
            <select className='b-create-offer-form-select' {...register("location.country")}>
              {JSON.parse(localStorage.getItem('copyoffer')).location && JSON.parse(localStorage.getItem('copyoffer')).location.country === 'España' ? <option value="España" select>España</option> : <option value="España">España</option>}
              {JSON.parse(localStorage.getItem('copyoffer')).location && JSON.parse(localStorage.getItem('copyoffer')).location.country === 'Francia' ? <option value="Francia" select>Francia</option> : <option value="Francia">Francia</option>}
              {JSON.parse(localStorage.getItem('copyoffer')).location && JSON.parse(localStorage.getItem('copyoffer')).location.country === 'Estados Unidos' ? <option value="Estados Unidos" select>Estados Unidos</option> : <option value="Estados Unidos">Estados Unidos</option>}
              {JSON.parse(localStorage.getItem('copyoffer')).location && JSON.parse(localStorage.getItem('copyoffer')).location.country === 'Australia' ? <option value="Australia" select>Australia</option> : <option value="Australia">Australia</option>}
            ...
            <textarea className='b-create-offer-form-textarea' {...register("conditions.requisites")} defaultValue={JSON.parse(localStorage.getItem('copyoffer')).conditions ? JSON.parse(localStorage.getItem('copyoffer')).conditions.requisites : ''}></textarea>
            <h5>Condiciones</h5>
            <label>Salario</label>
            <select className='b-create-offer-form-select' {...register("conditions.salary")}>
              {JSON.parse(localStorage.getItem('copyoffer')).conditions && JSON.parse(localStorage.getItem('copyoffer')).conditions.salary === '18k - 25k' ? <option value="18k - 25k" select>18k - 25k</option> : <option value="18k - 25k" >18k - 25k</option>}
              {JSON.parse(localStorage.getItem('copyoffer')).conditions && JSON.parse(localStorage.getItem('copyoffer')).conditions.salary === '25k - 35k' ? <option value="25k - 35k" select>25k - 35k</option> : <option value="25k - 35k" >25k - 35k</option>}
              {JSON.parse(localStorage.getItem('copyoffer')).conditions && JSON.parse(localStorage.getItem('copyoffer')).conditions.salary === '35k - 45k' ? <option value="35k - 45k" select>35k - 45k</option> : <option value="35k - 45k" >35k - 45k</option>}
              {JSON.parse(localStorage.getItem('copyoffer')).conditions && JSON.parse(localStorage.getItem('copyoffer')).conditions.salary === '45k - 70k' ? <option value="45k - 70k" select>45k - 70k</option> : <option value="45k - 70k" >45k - 70k</option>}
              {JSON.parse(localStorage.getItem('copyoffer')).conditions && JSON.parse(localStorage.getItem('copyoffer')).conditions.salary !== '18k - 25k' && JSON.parse(localStorage.getItem('copyoffer')).conditions.salary !== 'Francia' && JSON.parse(localStorage.getItem('copyoffer')).conditions.salary !== 'Estados Unidos' && JSON.parse(localStorage.getItem('copyoffer')).conditions.salary !== 'Australia' ? <option value={JSON.parse(localStorage.getItem('copyoffer')).conditions.salary} selected>{JSON.parse(localStorage.getItem('copyoffer')).conditions.salary}</option> : ''}

            </select>
            <label>Tipo de Jornada</label>
            <select className='b-create-offer-form-select' {...register("conditions.shift")}>
              {JSON.parse(localStorage.getItem('copyoffer')).conditions && JSON.parse(localStorage.getItem('copyoffer')).conditions.shift === 'Jornada Completa' ? <option value="Jornada Completa" select>Jornada Completa</option> : <option value="Jornada Completa">Jornada Completa</option>}
              {JSON.parse(localStorage.getItem('copyoffer')).conditions && JSON.parse(localStorage.getItem('copyoffer')).conditions.shift === 'Media Jornada' ? <option value="Media Jornada" select>Media Jornada</option> : <option value="Media Jornada">Media Jornada</option>}
              {JSON.parse(localStorage.getItem('copyoffer')).conditions && JSON.parse(localStorage.getItem('copyoffer')).conditions.shift !== 'Jornada Completa' && JSON.parse(localStorage.getItem('copyoffer')).conditions.shift !== 'Jornada Completa' ? <option value={JSON.parse(localStorage.getItem('copyoffer')).conditions.shift} selected>{JSON.parse(localStorage.getItem('copyoffer')).conditions.shift}</option> : ''}
            </select>
            <label>Tipo de contrato</label>
            <select className='b-create-offer-form-select' {...register("conditions.contract")}>
              {JSON.parse(localStorage.getItem('copyoffer')).conditions && JSON.parse(localStorage.getItem('copyoffer')).conditions.contract === 'Contrato Indefinido' ? <option value="Contrato Indefinido" select>Jornada Completa</option> : <option value="Contrato Indefinido">Contrato Indefinido</option>}
              {JSON.parse(localStorage.getItem('copyoffer')).conditions && JSON.parse(localStorage.getItem('copyoffer')).conditions.contract === 'Contrato Temporal' ? <option value="Contrato Temporal" select>Jornada Completa</option> : <option value="Contrato Temporal">Contrato Temporal</option>}
              {JSON.parse(localStorage.getItem('copyoffer')).conditions && JSON.parse(localStorage.getItem('copyoffer')).conditions.contract === 'Contrato de Prácticas' ? <option value="Contrato de Prácticas" select>Jornada Completa</option> : <option value="Contrato de Prácticas">Contrato de Prácticas </option>}
              {JSON.parse(localStorage.getItem('copyoffer')).conditions && JSON.parse(localStorage.getItem('copyoffer')).conditions.contract !== 'Contrato Indefinido' && JSON.parse(localStorage.getItem('copyoffer')).conditions.contract !== 'Contrato Temporal' && JSON.parse(localStorage.getItem('copyoffer')).conditions.contract !== 'Contrato de Prácticas' ? <option value={JSON.parse(localStorage.getItem('copyoffer')).conditions.contract} selected>{JSON.parse(localStorage.getItem('copyoffer')).conditions.contract}</option> : ''}
            </select>
            ...
            <select className='b-create-offer-form-select' {...register("conditions.availability")} defaultValue={localStorage.getItem('copyoffer').conditions && JSON.parse(localStorage.getItem('copyoffer')).conditions.availability}>
              {JSON.parse(localStorage.getItem('copyoffer')).conditions && JSON.parse(localStorage.getItem('copyoffer')).conditions.availability === 'Inmediata' ? <option value="Inmediata" select>Inmediata</option> : <option value="Inmediata">Inmediata</option>}
              {JSON.parse(localStorage.getItem('copyoffer')).conditions && JSON.parse(localStorage.getItem('copyoffer')).conditions.availability === '15 Días' ? <option value="15 Días" select>15 Días</option> : <option value="15 Días">15 Días</option>}
              {JSON.parse(localStorage.getItem('copyoffer')).conditions && JSON.parse(localStorage.getItem('copyoffer')).conditions.availability === '1 Mes' ? <option value="1 Mes" select>1 Mes</option> : <option value="1 Mes">1 Mes</option>}
              {JSON.parse(localStorage.getItem('copyoffer')).conditions && JSON.parse(localStorage.getItem('copyoffer')).conditions.availability !== 'Inmediata' && JSON.parse(localStorage.getItem('copyoffer')).conditions.availability !== '15 Días' && JSON.parse(localStorage.getItem('copyoffer')).conditions.availability !== '1 Mes' ? <option value={JSON.parse(localStorage.getItem('copyoffer')).conditions.availability} selected>{JSON.parse(localStorage.getItem('copyoffer')).conditions.availability}</option> : ''}
            </select>
